...
RSpec.describe "users", type: :feature do
  context "users/index.html.erb page" do
    before :each do
  ...
  context "users/show.html.erb" do
    before :each do
      ...
      # create posts
      Post.create(title: 'Title 1', text: 'Lorem ipsum dolor sit', author_id: User.first.id, comments_counter: 0, likes_counter: 0)
      ...
      Post.create(title: 'Title 4', text: 'Lorem ipsum dolor sit', author_id: User.first.id, comments_counter: 0, likes_counter: 0)
      Post.create(title: 'Title 5', text: 'Lorem ipsum dolor sit', author_id: User.first.id, comments_counter: 0, likes_counter: 0)
